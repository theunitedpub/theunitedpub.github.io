...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._image_4.onclick=function (e) {
			player.openUrl("tel:+375333657777","");
		}
		...
		me._image_1.onclick=function (e) {
			player.openUrl("https:\/\/www.instagram.com\/the_united_pub\/?utm_source=ig_profile_share&igshid=lmi6anzo5sq4","");
		}
...
this.__div.style.top = vs.height / 2 + "px";
	...
	function SkinHotspotClass_hotspot_1(parentScope,hotspot) {
		...
		me._hotspot_1.onclick=function (e) {
			player.openUrl("https:\/\/catalog.pivo.by\/place\/the-united-pub","");
			skin.hotspotProxyClick(me.hotspot.id, me.hotspot.url);
		}
		...
		me._hotspot_1.appendChild(me._image_5);
